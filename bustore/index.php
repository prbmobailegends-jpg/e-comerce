...
<style>
    ...
    .navbar-icons .navbar-dropdown a img {
        border-radius: 50%;
...
<div class="container">
    ...
    <section id="latest-products" class="featured-products">
        ...
        <a href="all_products.php" class="view-all-btn">Lihat Semua Produk</a>
    </section>

    <!-- Trust Elements -->
    <section class="trust-elements">
        <div class="trust-item">
            <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="#ff5722" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16,8 20,8 23,11 23,16 16,16 16,8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg>
            <h4>Pengiriman Cepat</h4>
            <p>Pesanan tiba 1-3 hari</p>
        </div>
        <div class="trust-item">
            <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="#ff5722" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
            <h4>100% Original</h4>
            <p>Produk terjamin asli</p>
        </div>
        <div class="trust-item">
            <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="#ff5722" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26 12,2"></polygon></svg>
